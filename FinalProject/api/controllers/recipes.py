...
def read_one(db: Session, item_id: int):
    return read_one_item(db, model.Recipe, model.Recipe.id, item_id)

def update(db: Session, item_id: int, request):
    return update_item(db, model.Recipe, model.Recipe.id, item_id, request)

def delete(db: Session, item_id: int):
    return delete_item(db, model.Recipe, model.Recipe.id, item_id)